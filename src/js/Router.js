...
export default qx.Class.define("Router", {
  ...
  members: {
    ...
    initializeViews: function () {
      ...
      APP.setAreaSelectionView(new AreaSelectionView());
      ...
      APP.getAreaSelectionView().render();
    },
    ...
    addEvents: function () {
      ...
      that.listen('fetchedAllData', function () {
        ...
        if (!that.urlParams || that.urlParams.length < 1) {
          ...
          /**
           * if user goes to afeefa.de, may ask for area
           * if user goes to leipzig.afeefa.de etc., do nothing and let him go
           */
